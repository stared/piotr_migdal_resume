...
% I would happily consider industries such as medtech, biotech, and user-centric AI.
...
\cvachievement{\faChartLine}{livelossplot}{Developed a popular Python library for visualizing deep learning model training, with over 2M installations.}

\divider

\cvachievement{\faFemale}{Data Science PL}{Created the largest data science community in Poland -- over 25k members.}
...
\cvevent{MSc\ in physics, BSc\ in mathematics}{University of Warsaw}{2005 -- 2011}{Warsaw, Poland}

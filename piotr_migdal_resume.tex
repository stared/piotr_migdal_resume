...
\tagline{deep learning specialist, technical leader \& visionary}
...
\item Lead development a state-of-the art numerical engine, which performs quantum computation real-time in the browser.
...
\item Created Virtual Lab, an interactive simulation of entangled photons, used at Standord and Oxford universities.
...
\begin{itemize}
\item Designed and lead implementation of deep learning models for simulating racing car physics \& unsupervised image segmentation.
...
\cvachievement{\faHeartbeat}{Inspiration \& impact}{Over 15 of my projects and writings have been featured on the Hacker News front page.}

\divider

\cvachievement{\faExpandArrows*}{Broad interests}{Research publications in quantum physics, mathematical psychology, educational games, and data visualization.}
